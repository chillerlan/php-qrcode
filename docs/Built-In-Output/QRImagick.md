...
[Class `QRImagick`](https://github.com/chillerlan/php-qrcode/blob/v6.0.x/src/Output/QRImagick.php): [ImageMagick](https://www.php.net/manual/book.imagick) output, [multiple supported image formats](https://imagemagick.org/script/formats.php)
...
See: [ImageMagick example](https://github.com/chillerlan/php-qrcode/blob/v6.0.x/examples/imagick.php)
