...
[Class `QRFpdf`](https://github.com/chillerlan/php-qrcode/blob/v6.0.x/src/Output/QRFpdf.php):
[Portable Document Format](https://en.wikipedia.org/wiki/PDF) (PDF) output via [FPDF](https://github.com/setasign/fpdf).


## Example

See: [FPDF example](https://github.com/chillerlan/php-qrcode/blob/v6.0.x/examples/fpdf.php)
