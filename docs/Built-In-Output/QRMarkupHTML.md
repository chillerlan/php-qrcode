...
[Class `QRMarkupHTML`](https://github.com/chillerlan/php-qrcode/blob/v6.0.x/src/Output/QRMarkupHTML.php): HTML output
...
See: [HTML example](https://github.com/chillerlan/php-qrcode/blob/v6.0.x/examples/html.php)
